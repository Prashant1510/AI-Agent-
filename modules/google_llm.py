...
llm = ChatGoogleGenerativeAI(
    ...
    temperature=0.7,
    google_api_key= os.getenv("GOOGLE_API_KEY") # Replace or load from .env
)

# Load memory
memory = ConversationBufferMemory(return_messages=True,memory_key="chat_history")
memory.chat_memory.messages = load_history()
...
if __name__ == "__main__":
    user_query = "write a sort story on turtle and rabbit"
